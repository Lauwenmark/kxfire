...
fun registerComponent(component: Component): Component {
    ...
    if (component.entity.contains(component.javaClass)) unregisterComponent(component.entity[component.javaClass]
...
/**
 * A [Component] describing an entity that can be controlled.
 *
 * An entity is "controlled" when there is any process giving it orders, and making it perform actions. The controller
 * can be a local player, a remote one acting through the network, or an AI, for example.
 */
